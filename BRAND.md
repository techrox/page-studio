...
A short, opinionated brand reference. The asset SVGs ship inside
[`examples/showcase/public/brand/`](./examples/showcase/public/brand/)
and the landing page reads them directly from there.
